...
export const SocialSignInButtons = ({ disabled = false }: SocialSignInButtonsProps) => {
    ...
    <>
      <div className="space-y-3 mb-6">
        <Button
          ...
          disabled={disabled || socialPending === 'google'}
        >
        ...
        <Button
          ...
          disabled={disabled || socialPending === 'facebook'}
        >
